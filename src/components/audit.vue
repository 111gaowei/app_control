      ...
      >
        ...
        <el-table-column
          ...
          :min-width="
            index == 0
              ? '50'
              : index == tables[cate - 1].content.length - 1
              ? '170'
              : index==1?'150':'130'
          "
        >
          <template slot-scope="scope">
            ...
            <div style="min-width: 160px">
              <!-- 按钮，通过或拒绝 -->
              <el-button v-show="item.show == 3" style="padding: 7px"
                >通过</el-button
              >
              <el-button v-show="item.show == 3" style="padding: 7px">{{
                cate == 1 ? "延迟审批" : "拒绝"
            ...
            <!-- 一般情况 -->
            <span style="min-width:100px" v-if="item.show == -1">{{
